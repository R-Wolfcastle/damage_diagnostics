...
t1a = t1.ReadAsArray()
t2a = gdal.Open(superdir + "modelled_speedheal_shelves_clin_jfnk.tiff").ReadAsArray()
...
array_to_geotiff(diff, t1, superdir+"damaged_shelves_speed_diff.tiff", compression="DEFLATE")
